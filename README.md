...
POST /api/registration/ - Register new user - No auth
POST /api/login/ - Login user - No auth
...
GET /api/offers/ - List all offers - No auth
...
GET /api/base-info/ - Platform statistics - No auth
